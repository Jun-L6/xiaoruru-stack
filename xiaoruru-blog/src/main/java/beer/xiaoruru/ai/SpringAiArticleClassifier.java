...
public class SpringAiArticleClassifier implements ArticleClassifier {
    ...
    public SpringAiArticleClassifier(ChatClient.Builder builder, CategoryRepository categories,
    ...
    public ClassificationResult classify(ArticleClassificationRequest request) {
        ...
        String response = invoke(SYSTEM_PROMPT, userPrompt);
        try {
